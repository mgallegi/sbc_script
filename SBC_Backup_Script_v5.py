...
# network_elements = {1:('SFE903-iSBC01','10.76.43.75'),
#                     2:('SFE903-iSBC02','10.76.43.76'),
#                     3:('SFE903-iSBC03','10.76.43.35'),
#                     4:('SFE903-iSBC04','10.76.43.36'),
#                     5:('SFE903-iSBC05','10.76.43.51'),
#                     6:('SFE903-iSBC06','10.76.43.52'),
#                     7:('SFE903-iSBC07','10.76.43.67'),
#                     8:('SFE903-iSBC08','10.76.43.68'),
#                     9:('SFE903-iSR01','10.76.43.10')
#                     }
...
for b in network_elements:
    ...
    try:
        ...
        try:
            ...
            ssh_log_file.write(element_name +' '+dt_string+' --> It was not possible to establish an SSH session with the element.\n')
            ssh_log_file.close()
